        ...
        <div className="grid items-start gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 text-lg leading-relaxed text-white">
              Cztery obszary pracy: od analizy opisowej i modeli predykcyjnych
              po sformułowanie prawdopodobieństwa oraz weryfikację strategii na
          ...
          <div className="lg:col-span-7">
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-5">
              {CARDS.map((c) => (
                <article
                  key={c.title}
                  className="group relative rounded-3xl border border-white/10 bg-slate-950/40 p-6 backdrop-blur transition-colors hover:border-primary/40 sm:p-7"
                >
